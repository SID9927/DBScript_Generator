        ...
        <div className="relative space-y-1.5">
            ...
            <div className="relative">
                <button
                    ...
                    className={`w-full bg-slate-950/50 border border-slate-800 rounded-xl transition-all hover:border-indigo-500/40 relative overflow-hidden text-left flex items-center justify-between group ${compact ? 'px-3 py-1.5 text-[10px]' : 'px-4 py-2.5 text-xs'} font-bold text-indigo-300 tracking-tight`}
                >
                            ...
                            <div className="max-h-60 overflow-y-auto custom-scrollbar">
                                {options.map((opt) => (
                                    ...
                                    >
                                        ...
                                        {value === opt.value && (
                                            <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 shadow-[0_0_8px_rgba(99,102,241,0.6)] shrink-0" />
                                        )}
                                    </button>
                                ))}
                            </div>
