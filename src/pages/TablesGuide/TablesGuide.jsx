...
const TablesGuide = () => {
    ...
    const tabs = [
        { id: 'guide', name: 'Strategic Guide', icon: '📚', sub: 'Foundational Schema' },
        { id: 'terms', name: 'Terms Dictionary', icon: '📖', sub: 'Structural Logic' },
        { id: 'playground', name: 'Architect Console', icon: '🏗', sub: 'T-SQL Engineering' }
    ];

    return (
        <div className="p-6 max-w-7xl mx-auto space-y-8">
            <SEO 
                title="SQL Tables Architecture | Developer Suite" 
                description="Master SQL Server table design, storage optimization, and relational integrity. Comprehensive guide to CRUD, Temporal tables, and more."
            />
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1 pr-12 text-left">
                            <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight uppercase italic leading-none">
                                SQL <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-indigo-600 pr-2">TABLES</span>
                            </h1>
                            <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[8px] italic leading-tight">
                                High-performance <span className="text-indigo-500/80">relational storage</span> architecture protocol
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6 bg-slate-950/40 px-6 py-4 rounded-[1.8rem] border border-slate-800/40 backdrop-blur-md shadow-inner">
                        ...
                        <div className="flex flex-col text-left">
                            <div className="text-[7px] font-black text-slate-600 uppercase tracking-[0.2em] mb-0.5 whitespace-nowrap font-mono">Architecture Grade</div>
                ...
                <div className="lg:w-80 w-full flex-shrink-0 lg:sticky lg:top-24 z-20">
                    <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-4 shadow-2xl space-y-2">
                        <div className="px-4 py-3 pb-5 text-left">
                            <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.4em] mb-1 italic">Structural Hub</h3>
                        ...
                        <div className="space-y-2">
                            {tabs.map((tab) => (
                                ...
                                >
                                    ...
                                    <AnimatePresence>
                                        {activeTab === tab.id && (
                                            <motion.div layoutId="tableTabPill" className="absolute inset-0 border-2 border-indigo-500/20 rounded-2xl shadow-[inset_0_0_20px_rgba(99,102,241,0.1)]" />
                                        )}
                                    </AnimatePresence>
                                </button>
                            ))}
                        ...
                        <div className="mt-4 pt-4 border-t border-slate-800/50 px-2 pb-2">
                             <div className="bg-slate-950/50 rounded-2xl p-4 border border-slate-800/40 text-left">
                                 <div className="flex items-center gap-2 mb-3">
                                     ...
                                     <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest font-mono">Row Density High</span>
                                 </div>
                                 <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter leading-tight italic">Normalized &gt; Optimized &gt; Stored</p>
                                 <p className="text-[8px] text-slate-600 font-medium uppercase tracking-widest mt-1">Audit Protocol V3</p>
                             </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            {activeTab === 'terms' && <Terms terms={tableTerms} />}
